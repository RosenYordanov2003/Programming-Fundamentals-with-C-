    ...
    internal class Program
    {
        static void Main(string[] args)
        {
          List<VechicleCatalogue> vechicles = new List<VechicleCatalogue>();
            ...
            List<VechicleCatalogue>cars=vechicles.Where(vechicle1=>vechicle1.Type==TypeVechicle.Car).ToList();
            List<VechicleCatalogue> truck = vechicles.Where(vehicle1 => vehicle1.Type==TypeVechicle.Truck).ToList();
            if (cars.Count>0)
            {
